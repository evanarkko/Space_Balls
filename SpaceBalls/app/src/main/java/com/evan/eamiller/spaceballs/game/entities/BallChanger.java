package com.evan.eamiller.spaceballs.game.entities;
...
import com.evan.eamiller.spaceballs.game.entities.characters.balls.FireBall;
import com.evan.eamiller.spaceballs.game.entities.characters.balls.GolfBall;
import com.evan.eamiller.spaceballs.game.entities.characters.balls.Laser;
import com.evan.eamiller.spaceballs.game.entities.characters.balls.Plasma;
import com.evan.eamiller.spaceballs.game.entities.characters.balls.TennisBall;
...
public class BallChanger implements drawable {
    ...
    private int plasmaId = R.drawable.plasma_missile_pb;
    ...
    public BallChanger(Player p) {
        ...
        this.sx = (int)(10*GamePanel.widthFactor);
        this.sy = (int)(10*GamePanel.heightFactor);; //HERE I ASSUME THAT THE GAME ALWAYS STARTS WITH THE TENNIS BALL
    ...
    public void changeBall(){
        ...
        switch(currentBallIndex){
            ...
            case 4:
                ...
                break;
            case 5:
                this.image = BitmapFactory.decodeResource(player.getContext().getResources(), plasmaId);
                this.image = Bitmap.createScaledBitmap(image, (int)((4*Laser.laserWidth/5)*GamePanel.widthFactor),
                        (int)((Plasma.PlasmaHeight)*GamePanel.heightFactor), true);
                sx = 13; sy = 3;
                break;
        }
    }
